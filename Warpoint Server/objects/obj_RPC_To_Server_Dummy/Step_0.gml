...
if send_message
{
    ...
    rpc_timeout=30;    
    // Script to run
    rpc_script_to_run=scr_RPC_dummy_return;
    
    htmerpc_send(self.rpc_id,rpc_script_to_run,obj_server_handler.htme_mp_player,TestData);
...
else
{
    ...
    if (!is_undefined(returnedValue)) 
    {
        ...
        if AllowRun
        {
            show_debug_message(returnedValue);        
        }
